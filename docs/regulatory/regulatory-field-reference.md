...
| 6 | 42–46 | 5 | Construction Progress % | decimal(5,2) | Not a land / building / land&building type → `0.00` (this includes **Condo**); bare Land/Leasehold → `100.00`; building types (LB/LSB/LS) → `100.00` if **completed** (not under construction), else the overall construction-progress percent (bounded 0–100). |
