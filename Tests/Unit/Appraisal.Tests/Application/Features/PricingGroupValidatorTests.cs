...
public class PricingGroupValidatorTests
{
    ...
    public void NoSurvey_FailsMakerSurvey()
    {
        ...
        Assert.False(result.Valid);
        Assert.Equal(PricingValidationStatus.Failed, Step(result, "MarketSurvey").Status);
    }
    ...
    public void WithSurvey_PassesMakerSurvey()
    {
        ...
        Assert.Equal(PricingValidationStatus.Passed, Step(result, "MarketSurvey").Status);
    }
