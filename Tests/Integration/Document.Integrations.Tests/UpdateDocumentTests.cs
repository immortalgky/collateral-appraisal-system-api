...
public class UpdateDocumentByIdTests(IntegrationTestFixture fixture) : IntegrationTestBase(fixture)
{
    ...
    // {
    //     // NOTE: This test is commented out because UpdateDocument feature was removed
    //     // Files are now saved directly to permanent storage during upload
    //     // TODO: Update this test to use the new upload session workflow
    //
