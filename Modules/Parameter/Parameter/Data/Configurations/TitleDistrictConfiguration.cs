...
public class TitleDistrictConfiguration : IEntityTypeConfiguration<TitleDistrict>
{
    public void Configure(EntityTypeBuilder<TitleDistrict> builder)
    {
        builder.ToTable("TitleDistricts");
