...
/// </summary>
public class UserLookupService(AuthDbContext db, UserManager<ApplicationUser> userManager) : IUserLookupService
{
    ...
    public async Task<string[]> GetUsernamesInRoleAsync(
        string role,
        Guid? companyId = null,
