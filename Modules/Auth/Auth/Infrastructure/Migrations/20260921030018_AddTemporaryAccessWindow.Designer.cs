...
namespace Auth.Infrastructure.Migrations
{
    ...
    [Migration("20260921030018_AddTemporaryAccessWindow")]
    partial class AddTemporaryAccessWindow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Auth.Domain.Auditing.AuthAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Auth.Domain.Configuration.PasswordPolicy", b =>
                {
                    ...
                    b.Property<int>("MaxAccessWindowHours")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(8);
            ...
            modelBuilder.Entity("Auth.Domain.Menu.ActivityMenuOverride", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("ActivityMenuOverrideId");
                    ...
                    b.HasIndex("ActivityId", "MenuItemId")
                        .IsUnique();

                    b.ToTable("ActivityMenuOverrides", "auth");
                });
            ...
            modelBuilder.Entity("Auth.Domain.Menu.MenuItem", b =>
                {
                    ...
                    b.Property<string>("ViewPermissionPrefix")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("Auth.Domain.Teams.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Teams", "auth", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("Auth.Domain.Teams.TeamMember", b =>
                {
            ...
            modelBuilder.Entity("Auth.Domain.Teams.TeamMember", b =>
                {
                    b.HasOne("Auth.Domain.Teams.Team", "Team")
                        .WithMany("Members")
