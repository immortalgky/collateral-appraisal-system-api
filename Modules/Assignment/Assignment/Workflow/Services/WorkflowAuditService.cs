...
public class WorkflowAuditService : IWorkflowAuditService
{
    ...
    public async Task LogActionExecutionAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        _logger.LogInformation("Action audit: {ActionType} ({ActionName}) for activity {ActivityId} - Success: {IsSuccess}, Duration: {Duration}ms", 
    ...
    public async Task LogAssignmentChangeAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        _logger.LogInformation("Assignment change: {ChangeType} for activity {ActivityId} - From: {PreviousAssignee} To: {NewAssignee}", 
    ...
    public async Task LogPerformanceMetricsAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        _logger.LogInformation("Performance audit: {Operation} for activity {ActivityId} - Success: {Success}, Duration: {Duration}ms", 
