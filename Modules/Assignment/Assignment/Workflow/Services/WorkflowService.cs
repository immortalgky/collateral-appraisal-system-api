...
public class WorkflowService : IWorkflowService
{
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            var executionResult = await _workflowEngine.StartWorkflowAsync(
                workflowDefinitionId, instanceName, startedBy, initialVariables, correlationId, assignmentOverrides, cancellationToken);
            ...
            // 2. SAVE RESULT via PersistenceService
            var savedInstance =
                await _persistenceService.SaveWorkflowInstanceAsync(executionResult.WorkflowInstance,
                    cancellationToken);
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            // 2. SAVE RESULT via PersistenceService
            await _persistenceService.UpdateWorkflowInstanceAsync(executionResult.WorkflowInstance, cancellationToken);
