...
public class ProjectTowerConfiguration : IEntityTypeConfiguration<ProjectTower>
{
    public void Configure(EntityTypeBuilder<ProjectTower> builder)
    {
        builder.ToTable("ProjectTowers");
