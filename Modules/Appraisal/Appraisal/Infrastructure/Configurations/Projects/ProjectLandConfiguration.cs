...
public class ProjectLandConfiguration : IEntityTypeConfiguration<ProjectLand>
{
    public void Configure(EntityTypeBuilder<ProjectLand> builder)
    {
        builder.ToTable("ProjectLands");
        ...
        // LandOffice is a separate scalar on ProjectLand (below), not part of the VO.
        ...
        // ProjectLandTitles (owned collection)
        builder.OwnsMany(e => e.Titles, title =>
        {
            title.ToTable("ProjectLandTitles");
            title.WithOwner().HasForeignKey(t => t.ProjectLandId);
            title.HasKey(t => t.Id);
            ...
            title.HasIndex(t => t.ProjectLandId);
        });
