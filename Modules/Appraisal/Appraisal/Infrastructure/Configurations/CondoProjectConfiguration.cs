...
public class CondoProjectConfiguration : IEntityTypeConfiguration<CondoProject>
{
    public void Configure(EntityTypeBuilder<CondoProject> builder)
    {
        builder.ToTable("CondoProjects");
        ...
        builder.Property(e => e.BuiltOnTitleDeedNumber).HasMaxLength(200);
