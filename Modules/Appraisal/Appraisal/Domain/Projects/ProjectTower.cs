...
/// <summary>
/// Tower within a Condo project. Only created when ProjectType = Condo.
/// Moved from CondoTower; AppraisalId replaced by ProjectId.
/// </summary>
public class ProjectTower : Entity<Guid>
{
    ...
    public static ProjectTower Create(Guid projectId)
    {
        return new ProjectTower
        {
    ...
    public static ProjectTower Create(Guid projectId, string towerName)
    {
        return new ProjectTower
        {
            Id = Guid.CreateVersion7(),
