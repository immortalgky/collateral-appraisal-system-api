...
/// <summary>
/// Village/LandAndBuilding project land details.
/// Moved from VillageProjectLand; AppraisalId replaced by ProjectId.
/// Only relevant when ProjectType = LandAndBuilding.
/// </summary>
public class ProjectLand : Entity<Guid>
{
    private readonly List<ProjectLandTitle> _titles = [];
    public IReadOnlyList<ProjectLandTitle> Titles => _titles.AsReadOnly();
    ...
    public static ProjectLand Create(Guid projectId)
    {
        return new ProjectLand
        {
    ...
    public void AddTitle(ProjectLandTitle title)
    {
        _titles.Add(title);
    }
    ...
    public void UpdateTitle(ProjectLandTitle updatedTitle)
    {
