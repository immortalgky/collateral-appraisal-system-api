...
/// <summary>
/// Building cost depreciation detail for LandAndBuilding project model buildings.
...
/// </summary>
public class ProjectModelDepreciationDetail : Entity<Guid>
{
    ...
    private readonly List<ProjectModelDepreciationPeriod> _depreciationPeriods = [];
    public IReadOnlyList<ProjectModelDepreciationPeriod> DepreciationPeriods => _depreciationPeriods.AsReadOnly();

    private ProjectModelDepreciationDetail()
    {
    }

    public static ProjectModelDepreciationDetail Create(
        Guid projectModelId,
        ...
        decimal priceDepreciation = 0)
    {
        ...
        return new ProjectModelDepreciationDetail
        {
    ...
    public ProjectModelDepreciationPeriod AddPeriod(
        int atYear,
        int toYear,
    ...
    {
        var period = ProjectModelDepreciationPeriod.Create(
