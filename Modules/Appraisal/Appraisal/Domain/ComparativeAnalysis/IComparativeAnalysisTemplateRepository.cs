...
public interface IComparativeAnalysisTemplateRepository
{
    ...
    Task<ComparativeAnalysisTemplate?> GetByTemplateCodeAsync(string templateCode,
        CancellationToken cancellationToken = default);

    Task<ComparativeAnalysisTemplate?> GetByPropertyTypeAsync(string propertyType,
        CancellationToken cancellationToken = default);

    Task<IReadOnlyList<ComparativeAnalysisTemplate>> GetAllAsync(CancellationToken cancellationToken = default);

    Task<IReadOnlyList<ComparativeAnalysisTemplate>> GetActiveTemplatesAsync(
        CancellationToken cancellationToken = default);
