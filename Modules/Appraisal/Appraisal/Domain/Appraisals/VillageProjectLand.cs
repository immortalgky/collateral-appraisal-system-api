...
/// <summary>
/// Village project land details including location, access, utilities, legal restrictions, and boundaries.
/// 1:1 relationship with Appraisal (village project property type).
/// </summary>
public class VillageProjectLand : Entity<Guid>
{
    private readonly List<VillageProjectLandTitle> _titles = [];
    public IReadOnlyList<VillageProjectLandTitle> Titles => _titles.AsReadOnly();
    ...
    private VillageProjectLand()
    {
        // For EF Core
    }

    public static VillageProjectLand Create(Guid appraisalId)
    {
        return new VillageProjectLand
        {
    ...
    /// <summary>
    /// Update all village project land detail fields
    /// </summary>
    ...
    public void AddTitle(VillageProjectLandTitle title)
    {
        _titles.Add(title);
    }
    ...
    public void UpdateTitle(VillageProjectLandTitle updatedTitle)
    {
