...
public class CondoProject : Entity<Guid>
{
    ...
    private CondoProject()
    {
    }

    public static CondoProject Create(Guid appraisalId)
    {
        return new CondoProject
        {
        ...
        string? remark = null)
    {
        ...
        BuiltOnTitleDeedNumber = builtOnTitleDeedNumber;
