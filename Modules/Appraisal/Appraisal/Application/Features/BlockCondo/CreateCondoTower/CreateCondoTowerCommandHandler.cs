...
public class CreateCondoTowerCommandHandler(
    IAppraisalRepository appraisalRepository,
    IAppraisalUnitOfWork unitOfWork
) : ICommandHandler<CreateCondoTowerCommand, CreateCondoTowerResult>
{
    public async Task<CreateCondoTowerResult> Handle(
        CreateCondoTowerCommand command,
        CancellationToken cancellationToken)
    {
        ...
        var tower = appraisal.AddCondoTower();
        ...
        return new CreateCondoTowerResult(tower.Id);
    }
}
