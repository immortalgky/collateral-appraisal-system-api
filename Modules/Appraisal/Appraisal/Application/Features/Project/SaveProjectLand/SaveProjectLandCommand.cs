...
/// <summary>Command to save project land details (LandAndBuilding only).</summary>
public record SaveProjectLandCommand(
    Guid AppraisalId,
    ...
    string? Remark = null,
    List<ProjectLandTitleDto>? Titles = null
) : ICommand<SaveProjectLandResult>, ITransactionalCommand<IAppraisalUnitOfWork>;
