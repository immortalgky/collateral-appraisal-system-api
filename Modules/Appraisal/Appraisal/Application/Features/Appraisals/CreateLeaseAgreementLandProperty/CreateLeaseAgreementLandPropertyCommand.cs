...
/// <summary>
/// Command to create a new lease agreement land property with detail
/// </summary>
...
) : ICommand<CreateLeaseAgreementLandPropertyResult>, ITransactionalCommand<IAppraisalUnitOfWork>;
