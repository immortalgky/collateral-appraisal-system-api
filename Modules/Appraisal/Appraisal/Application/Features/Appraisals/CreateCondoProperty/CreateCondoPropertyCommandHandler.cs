...
) : ICommandHandler<CreateCondoPropertyCommand, CreateCondoPropertyResult>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        property.CondoDetail!.Update(
            ...
            command.ModelName,
            command.BuiltOnTitleNo,
            command.CondoRegistrationNo,
            command.RoomNo,
            command.FloorNo,
            command.UsableArea,
            coordinates,
            ...
            command.PublicUtility,
            command.PublicUtilityOther,
            command.DecorationType,
            command.DecorationTypeOther,
            command.BuildingAge,
            command.ConstructionYear,
            command.NumberOfFloors,
            command.BuildingForm,
            command.ConstructionMaterialType,
            command.RoomLayoutType,
            command.RoomLayoutTypeOther,
            command.LocationView,
            command.GroundFloorMaterial,
            command.GroundFloorMaterialOther,
            command.UpperFloorMaterial,
            command.UpperFloorMaterialOther,
            command.BathroomFloorMaterial,
            command.BathroomFloorMaterialOther,
            command.RoofType,
