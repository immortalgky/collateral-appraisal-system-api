...
) : ICommandHandler<UpdateLeaseAgreementLandAndBuildingPropertyCommand>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (property.PropertyType != PropertyType.LeaseAgreementLandAndBuilding)
            throw new InvalidOperationException($"Property {command.PropertyId} is not a lease agreement land and building property");
        ...
        // 9. Update lease agreement detail if provided
        ...
        // 10. Update rental info if provided
