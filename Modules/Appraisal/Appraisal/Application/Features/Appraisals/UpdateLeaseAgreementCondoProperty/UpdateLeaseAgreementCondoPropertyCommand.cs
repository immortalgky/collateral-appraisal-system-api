...
/// <summary>
/// Command to update a lease agreement condo property detail
/// </summary>
public record UpdateLeaseAgreementCondoPropertyCommand(
    Guid AppraisalId,
    Guid PropertyId,
    ...
    bool? IsUnderConstruction = null,    // Unit deed identifiers (collateral dedup key)
