...
/// <summary>
/// Handler for creating a lease agreement land and building property with its appraisal detail
/// </summary>
public class CreateLeaseAgreementLandAndBuildingPropertyCommandHandler(
    IAppraisalRepository appraisalRepository,
    IAppraisalUnitOfWork unitOfWork
) : ICommandHandler<CreateLeaseAgreementLandAndBuildingPropertyCommand, CreateLeaseAgreementLandAndBuildingPropertyResult>
{
    public async Task<CreateLeaseAgreementLandAndBuildingPropertyResult> Handle(
        CreateLeaseAgreementLandAndBuildingPropertyCommand command,
        CancellationToken cancellationToken)
    {
        ...
        var property = appraisal.AddLeaseAgreementLandAndBuildingProperty();
        ...
        // 6d. Update lease agreement detail if provided
        ...
        return new CreateLeaseAgreementLandAndBuildingPropertyResult(property.Id, property.LandDetail.Id);
    }
