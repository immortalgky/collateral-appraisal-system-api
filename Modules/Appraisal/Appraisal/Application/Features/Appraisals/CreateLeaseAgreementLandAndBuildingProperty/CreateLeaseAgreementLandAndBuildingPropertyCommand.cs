...
/// <summary>
/// Command to create a lease agreement land and building property with its appraisal detail
/// </summary>
public record CreateLeaseAgreementLandAndBuildingPropertyCommand(
    Guid AppraisalId,
    Guid? GroupId = null,
...
) : ICommand<CreateLeaseAgreementLandAndBuildingPropertyResult>, ITransactionalCommand<IAppraisalUnitOfWork>;
