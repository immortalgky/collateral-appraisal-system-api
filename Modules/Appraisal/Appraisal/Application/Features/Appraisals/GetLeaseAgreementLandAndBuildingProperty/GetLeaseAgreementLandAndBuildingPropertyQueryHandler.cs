...
/// <summary>
/// Handler for getting a lease agreement land and building property with its detail
/// </summary>
public class GetLeaseAgreementLandAndBuildingPropertyQueryHandler(
    IAppraisalRepository appraisalRepository
) : IQueryHandler<GetLeaseAgreementLandAndBuildingPropertyQuery, GetLeaseAgreementLandAndBuildingPropertyResult>
{
    public async Task<GetLeaseAgreementLandAndBuildingPropertyResult> Handle(
        GetLeaseAgreementLandAndBuildingPropertyQuery query,
        CancellationToken cancellationToken)
    {
        ...
        if (property.PropertyType != PropertyType.LeaseAgreementLandAndBuilding)
            throw new InvalidOperationException($"Property {query.PropertyId} is not a lease agreement land and building property");
        ...
        return new GetLeaseAgreementLandAndBuildingPropertyResult(
            // Property
            property.Id,
