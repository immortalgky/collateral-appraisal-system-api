...
/// when a quotation's CutOffTime passes.
///
/// Flow:
///   QuotationAutoCloseService → QuotationCutOffTimePassedIntegrationEvent
...
/// </summary>
public class QuotationCutOffTimePassedIntegrationEventConsumer(
    ISender mediator,
    IPublishEndpoint publishEndpoint,
    IWorkflowInstanceRepository instanceRepository,
    InboxGuard<WorkflowDbContext> inboxGuard,
    ILogger<QuotationCutOffTimePassedIntegrationEventConsumer> logger)
    : IConsumer<QuotationCutOffTimePassedIntegrationEvent>
{
    ...
    public async Task Consume(ConsumeContext<QuotationCutOffTimePassedIntegrationEvent> context)
    {
        ...
        logger.LogInformation(
            "QuotationCutOffTimePassedConsumer: processing QuotationRequestId={QuotationRequestId}",
        ...
        logger.LogInformation(
            "QuotationCutOffTimePassedConsumer: archived {ArchivedCount} overdue task(s) for workflow {WorkflowInstanceId}",
