...
namespace Collateral.Migrations
{
    ...
    [Migration("20260813164025_AddEngagementConstructionStatus")]
    partial class AddEngagementConstructionStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Collateral.CollateralMasters.Models.CollateralEngagement", b =>
                {
                    ...
                    b.Property<string>("RecordIndicator")
                        .HasMaxLength(1)
                    ...
                    b.HasIndex("HostCollateralId")
                        .HasDatabaseName("IX_CollateralEngagements_HostCollateralId")
                        .HasFilter("[HostCollateralId] IS NOT NULL");

                    b.HasIndex("IsUnderConstruction")
            ...
            modelBuilder.Entity("Collateral.CollateralMasters.Models.LandDetail", b =>
                {
                    ...
                    b.HasIndex("Province", "District", "SubDistrict", "TitleNumber")
                        .IsUnique()
