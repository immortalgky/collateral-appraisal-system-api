...
public class DocumentConfiguration : IEntityTypeConfiguration<Domain.Documents.Models.Document>
{
    public void Configure(EntityTypeBuilder<Domain.Documents.Models.Document> builder)
    {
