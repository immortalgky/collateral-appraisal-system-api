...
public class
    MarkNotificationAsReadHandler : ICommandHandler<MarkNotificationAsReadCommand, MarkNotificationAsReadResponse>
{
    ...
    public async Task<MarkNotificationAsReadResponse> Handle(MarkNotificationAsReadCommand request,
