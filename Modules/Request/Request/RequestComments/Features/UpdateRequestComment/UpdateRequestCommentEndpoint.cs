...
public class UpdateRequestCommentEndpoint : ICarterModule
{
    ...
    {
        app.MapPatch("/requests/{requestId}/comments/{commentId:long}", async (
                Guid requestId,
                long commentId,
            ...
            .WithDescription(
                "Updates an existing comment on the specified request. Only the comment text can be modified.")
