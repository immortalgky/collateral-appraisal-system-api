...
public class AddRequestCommentEndpoint : ICarterModule
{
    ...
    {
        app.MapPost("/requests/{requestId}/comments",
            ...
            .WithDescription(
                "Adds a new comment to the specified request. Comments are used to track communication and notes related to the appraisal request.")
