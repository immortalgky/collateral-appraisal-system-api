    ...
    : IQueryHandler<GetRequestTitleByIdQuery, GetRequestTitleByIdResult>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var result = new GetRequestTitleByIdResult(
            ...
            requestTitle.VehicleInfo.VehicleType,
            requestTitle.VehicleInfo.VehicleAppointmentLocation,
            requestTitle.VehicleInfo.ChassisNumber,
            requestTitle.MachineInfo.MachineStatus,
            requestTitle.MachineInfo.MachineType,
            requestTitle.MachineInfo.InstallationStatus,
            requestTitle.MachineInfo.InvoiceNumber,
            requestTitle.MachineInfo.NumberOfMachinery,
