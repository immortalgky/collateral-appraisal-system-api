...
public class SyncDraftRequestTitleDocumentsHandler(ISender sender, IBus bus) : ICommandHandler<SyncDraftRequestTitleDocumentsCommand, SyncDraftRequestTitleDocumentsResult>
{
