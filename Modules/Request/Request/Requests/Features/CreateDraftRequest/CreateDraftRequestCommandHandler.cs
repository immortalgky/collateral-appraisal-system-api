...
{
    public async Task<CreateDraftRequestResult> Handle(CreateDraftRequestCommand command,
    ...
    private static Models.Request CreateDraftRequest(
    ...
    )
    {
        ...
        var request = Models.Request.CreateDraft(
